# Welcome to SignInEveryTuesday Discussions! 欢迎来到 SignInEveryTuesday 讨论区！
...
<--
  ...
  🔗 如果你使用 issue 模板，请**给出相关 issue 模板**（如提问和社区对话）**的链接**到讨论区。将社区内容引向讨论区的相应位置，可以让你的 issues 更加整洁。如果你需要帮助，请点击[帮助文档链接](https://docs.github.com/en/github/building-a-strong-community/configuring-issue-templates-for-your-repository#configuring-the-template-chooser)。

  ➡️ You can **convert issues to discussions** either individually or bulk by labels. Looking at you, issues labeled “question” or “discussion”.
  
  ➡️ 你可以一个一个或按标签批量地**将 issues 转移到讨论区**。可以按你的意愿将 issues 标记为“问题”或“讨论”。
